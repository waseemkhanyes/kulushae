...
import SwiftUI
import Kingfisher
struct RecentAdView: View {
    
    @Binding var advList: [PropertyData]
                    ...
                    Button {
                        ...
                        VStack(alignment: .leading, spacing: 10) {
                            HStack{
                                ...
                                //                            AsyncImage(url: URL(string: (Config.imageBaseUrl) + (advList[index].images?.first?.image ?? ""))) { image in
                                //                                image
                                //                                    .resizable()
                                //                                    .aspectRatio(contentMode: .fill)
                                //                                    .frame(width: 163, height: 135)
                            ...
                            HStack(spacing: 5){
                                Image("location_pin")
                                    .padding(.leading, 15)
                                Text(advList[index].neighbourhood ?? "")
                                    .font(.roboto_14())
                                    .font(.headline.weight(.semibold))
                                    .multilineTextAlignment(.leading)
